// Error handler removed to prevent user-facing alerts. Check console for details.
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (window.location.pathname.includes('admin.html')) {
        ...
        // initQuickViewSlider(); // Initialize Slider on Home (Removed)
        initCardSlider(); // Initialize New Card Slider
...
function initCardSlider() {
    ...
    function updateSlider() {
        ...
        // Logic: Move by percentage width * index
        // Limit index so we don't scroll past end (unless infinite, but simple is better)
        ...
        // Gap adjustment is tricky with 100% width math, but flex gap handles visualization
        // Standard transform
...
function showThankYouModal(name, type) {
    ...
    if (type === 'Hotel Room') {
        msgElement.innerHTML = `Dear <strong>${name}</strong>,<br>Thank you for booking a room at HOTEL NATRAJ. We have received your request and will confirm your stay shortly.`;
    } else {
        msgElement.innerHTML = `Dear <strong>${name}</strong>,<br>Thank you for choosing HOTEL NATRAJ for your special event. We have received your booking request for the Wedding Hall.`;
    }
...
const roomGalleryData = {
    'Deluxe': [
        { src: "images/Deluxeroom-1.jpg", caption: "Deluxe Room - Main View" },
        { src: "images/Deluxeromm-3.avif", caption: "Deluxe Room - Interior" },
        { src: "images/Deluxeroom-2.avif", caption: "Deluxe Room - Bed View" }
    ],
    'Suite': [
        { src: "images/Suiteroom-1.avif", caption: "Executive Suite - Main View" },
        { src: "images/Suiteroom-2.jpg", caption: "Executive Suite - Spacious Living" },
        { src: "images/Suiteroom-3.jpg", caption: "Executive Suite - Bedroom" }
    ]
};
